def main():
    ...
    if vin in vehicles_dict:
        ...
        vehicle_data = vehicles_dict[vin] # Get the list of data for the vehicle.
        manufacturer = vehicle_data[MANUFACTURER_INDEX] # Get the manufacturer.
        model = vehicle_data[MODEL_INDEX]# Get the model
        color = vehicle_data[COLOR_INDEX] # Get the color
